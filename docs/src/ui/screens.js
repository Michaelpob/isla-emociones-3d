...
import { TOOL_LIST, TOOLS, BADGES } from '../data/tools.js?v=20260908174045';
import { gameState, getProgressSummary, ISLAND_CHAIN } from '../data/gameState.js?v=20260908174045';
