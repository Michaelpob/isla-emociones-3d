import { islands, minigameLabels } from '../data/islands.js?v=20260908180131';
import { WorldScene } from '../three/WorldScene.js?v=20260908180131';
import { minigameRegistry } from '../minigames/index.js?v=20260908180131';
import { getPlayer, savePlayer, hasPlayer, avatars, favoriteColors } from '../data/player.js?v=20260908180131';
import {
  gameState,
  loadProgress,
  isUnlocked,
  ...
  addReward,
  ISLAND_CHAIN
} from '../data/gameState.js?v=20260908180131';
import { BADGES } from '../data/tools.js?v=20260908180131';
import { openToolbox, openProgress, openFinal } from './screens.js?v=20260908180131';
