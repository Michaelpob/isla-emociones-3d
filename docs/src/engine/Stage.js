...
import { TOOLS } from '../data/tools.js?v=20260908180131';
import { addPoints, addReward, prefersReducedMotion, gameState, setSetting } from '../data/gameState.js?v=20260908180131';
